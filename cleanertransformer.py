...
def get_summary_statistics(input_df):
    summary_stats = input_df.describe().T
    # add median to summary statistics
    summary_stats["median"] = input_df.median(numeric_only=True)
    # reorder columns
    ...
    summary_stats = summary_stats.iloc[1:].round(2)
...
def main():
    ...
    # dictionary to store outliers count for each variable
    outlier_count = {}
    ...
    summary_statistics_after = get_summary_statistics(df)
